...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rxBleClient = AutoOilerApplication.getRxBleClient(this);
        configureResultList();
    }
 ...
 //                               .setDeviceName("AutoOiler")
    ...
    private void onAdapterItemClick(ScanResult scanResults) {
        ...
        final UUID uid = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");

        final Intent intent = new Intent(this, CharacteristicOperationExampleActivity.class);
        intent.putExtra(CharacteristicOperationExampleActivity.EXTRA_MAC_ADDRESS, macAddress);
        intent.putExtra(CharacteristicOperationExampleActivity.EXTRA_CHARACTERISTIC_UUID, uid);
